...
%	\node (s1a)[anchor=base] at (-.5, 0) {òk} ; 
%	\node (s1)[anchor=base, fill=black!30, inner sep=3.5pt] at (0, 0) {o};
%	\node (gl1)[anchor=base] at (-.15, -.4) {man} ; 
%	\node (wb)[anchor=base] at (0.5, 0) {\#} ; 
%	\node (s2)[anchor=base] at (1, 0) {e} ; 
%	\node (ss)[anchor=base] at (1.3, 0) {dèì} ; 
...
% grey highlight FIRST (so it stays behind)
% \fill[gray!20] (-0.15,-0.2) rectangle (0.3,1.5);
		\node (s1)[anchor=base] at (-.5, 0) {C} ; 
		\node (s1)[anchor=base, fill=gray!30, inner sep=3.5pt] at (0, 0) {V};
%		\node (gl1)[anchor=base] at (-.15, -.4) {climb} ; 
		\node (wb)[anchor=base] at (0.5, 0) {\#} ; 
		\node (s2)[anchor=base] at (1, 0) {V} ; 
		\node (ss)[anchor=base] at (1.3, 0) {C} ; 
%		\node (gl2)[anchor=base] at (1.15, -.4) {palm tree} ; 

		\node[fill=gray!30, inner sep=3.5 pt](t1) at (0,1) {T_1} ; 
		\node (t2) at (1,1) {T_2} ;
